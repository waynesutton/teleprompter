...
export const save = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    const nextItem = {
      ...
      transcriptText: cleanOptional(args.transcriptText),
      editPlan: cleanOptional(args.editPlan),
      edlJson: cleanOptional(args.edlJson),
      subtitleStyle: cleanOptional(args.subtitleStyle),
      renderChecklist: cleanOptional(args.renderChecklist),
      projectMemory: cleanOptional(args.projectMemory),
      outputFormat: cleanOptional(args.outputFormat),
