...
export default defineSchema({
  ...
  videoJobs: defineTable({
    ...
    provider: v.optional(v.union(v.literal("heygen-hyperframes"), v.literal("convex-sandbox-daytona"))),
    providerRenderId: v.optional(v.string()),
    providerStatus: v.optional(v.string()),
    renderRequestedAt: v.optional(v.number()),
    renderCheckedAt: v.optional(v.number()),
    renderCompletedAt: v.optional(v.number()),
    errorMessage: v.optional(v.string()),
    sandboxJobId: v.optional(v.string()),
    sandboxId: v.optional(v.string()),
    sandboxStatus: v.optional(v.string()),
    sandboxStartedAt: v.optional(v.number()),
    sandboxCompletedAt: v.optional(v.number()),
    sandboxArtifactPath: v.optional(v.string()),
    sandboxArtifactStorageId: v.optional(v.string()),
    sandboxArtifactUrl: v.optional(v.string()),
    mp4StorageId: v.optional(v.string()),
